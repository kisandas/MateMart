...
class ImageSlider @JvmOverloads constructor(
    ...
    private var sliderlistner: matemart.material.interior.interfaces.SliderItemClickListner? = null
    ...
    init {
        ...
        unselectedDot = typedArray.getResourceId(
            ...
            R.drawable.bg_round_corner_dot_unselected
        )
     ...
     */
    fun setItemClickListener(itemClickListener: matemart.material.interior.interfaces.SliderItemClickListner) {
