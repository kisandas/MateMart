...
import matemart.material.interior.fragments.StateSelectionBottomSheetFragment
import matemart.material.interior.fragments.CitySelectionBottomSheetFragment
...
import matemart.material.interior.api.Constants.CHECK_PINCODE
import matemart.material.interior.api.Constants.statList
...
class LocationActivity : AppCompatActivity(), DismissBottomSheet {
    ...
    fun initializeView() {
        for (i in matemart.material.interior.api.Constants.statList.indices) {
            stateList.add(matemart.material.interior.api.Constants.statList[i].state)
        }
...
//        et_state.setAdapter(adapter_state);
    ...
    fun VerifyPINCODE(CITY: String?, PINCODE: String?) {
        ...
        val jsonObjectRequest: JsonObjectRequest = object : JsonObjectRequest(
            Method.POST,
            matemart.material.interior.api.Constants.BASE_URL + CHECK_PINCODE,
            jsonObject,
            Response.Listener { response ->
                try {
                    ...
                    if (statusCode == 11) {
                        isPINCODE_VERIFIED = true
                        matemart.material.interior.utils.Toast.Toaster.Builder(this@LocationActivity)
                            .setTitle("Success")
...
//                                startActivity(new Intent(LocationActivity.this, HomeActivity.class));
                    ...
                    matemart.material.interior.utils.Toast.Toaster.Builder(this@LocationActivity)
                        .setTitle(matemart.material.interior.utils.Utils.ERROR_TITLE)
                        .setDescription(matemart.material.interior.utils.Utils.ERROR_MESSAGE)
                        .setDuration(5000)
                        .setStatus(matemart.material.interior.utils.Toast.Toaster.Status.ERROR)
                        .show()
                    e.printStackTrace()
