package matemart.material.Interior.viewmodel
...
import matemart.material.Interior.api.ApiRepository
import matemart.material.Interior.api.WebResponse
        ...
        if (response.isSuccessful) {
            ...
            if (response.body()?.statuscode == 11) {
                loginResponse.postValue(
                    WebResponse(
                        matemart.material.Interior.annotations.Status.SUCCESS,
                        result,
                        result?.message
                    )
                )
                ...
                loginResponse.postValue(
                    WebResponse(
                        matemart.material.Interior.annotations.Status.FAILURE,
                        result,
                        result?.message
                    )
                )
            ...
            loginResponse.postValue(
                WebResponse(
                    matemart.material.Interior.annotations.Status.SERVER_FAILURE,
                    null,
                    response.message()
                )
            )
