...
class ViewPagerAdapter(
    private var cardPosition: Int, context: Context?,
    ...
    private var textAlign: String, private var sliderlistner: matemart.material.Interior.interfaces.SliderItemClickListner
) : PagerAdapter() {
    ...
    constructor(
        ...
        titleBackground: Int,
        textAlign: String,
        sliderlistner: matemart.material.Interior.interfaces.SliderItemClickListner
    ) :
            this(
                cardPosition,
                context,
    ...
    private var itemClickListener: matemart.material.Interior.interfaces.SliderItemClickListner? = null
...
//        imageView.setOnClickListener{itemClickListener?.onItemSelected(position)}
        ...
        imageView.setOnClickListener(View.OnClickListener {
            sliderlistner.ItemClick(cardPosition, position)
        })
     ...
     */
    fun setItemClickListener(sliderlistner: matemart.material.Interior.interfaces.SliderItemClickListner) {
