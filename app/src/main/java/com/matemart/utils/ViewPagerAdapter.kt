...
class ViewPagerAdapter(
    ...
    private var textAlign: String, private var sliderlistner: SliderItemClickListner
) : PagerAdapter() {
    ...
    constructor(
        ...
        titleBackground: Int,
        textAlign: String,
        sliderlistner: SliderItemClickListner
    ) :
            this(
                cardPosition,
                context,
    ...
    private var itemClickListener: SliderItemClickListner? = null
...
//        imageView.setOnClickListener{itemClickListener?.onItemSelected(position)}
     ...
     */
    fun setItemClickListener(sliderlistner: SliderItemClickListner) {
