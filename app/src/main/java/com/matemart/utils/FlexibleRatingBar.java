...
public class FlexibleRatingBar extends androidx.appcompat.widget.AppCompatRatingBar {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < getNumStars(); ++i) {
            ...
            path.computeBounds(rectangle, true);
            path.offset((i + 2.5F) * getWidth() / getNumStars() - rectangle.centerX(), getHeight() / 2 - rectangle.centerY());
